...
The hadronization process takes account of the confinement of partons into the formation of the observed final-state hadrons. The event generators rely on strings or clusters. model for the simulation of this step.~\cite{Andersson:1983ia}
