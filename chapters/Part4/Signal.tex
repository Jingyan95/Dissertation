...
The effective Lagrangian is implemented using the SMEFTsim~\cite{Brivio:2017btx} package, which is the common standard agreed by the \ac{ATLAS} and \ac{CMS} Collaborations. 

Kinematic distributions of the simulated signal events at the generator-level are shown in Figure~\ref{fig:SigGen}.
