...
\sffamily
\centering
\caption{Representive range of all systematic uncertainties extracted from the 2017 dataset, excluding luminosity and cross-section uncertainties. \ac{JES}, \ac{JER}, and HEM are combined into ``JEC''. Sources of b-tagging uncertainties listed in Table~\ref{tab:btagsys} are combined into ``BtagSF''.}
\resizebox{0.95\linewidth}{!}{%
\begin{tabular}{ccccc}
\toprule
\multirow{2}{*}{Sys. Unc.} & \multicolumn{2}{c}{SR1} & \multicolumn{2}{c}{SR2} \\
